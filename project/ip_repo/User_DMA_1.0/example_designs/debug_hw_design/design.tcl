...
proc create_ipi_design { offsetfile design_name } {
	...
	# Connect all clock & reset of User_DMA_0 slave interfaces..
	connect_bd_intf_net [get_bd_intf_pins axi_peri_interconnect/M00_AXI] [get_bd_intf_pins User_DMA_0/S_AXI_LITE]
	connect_bd_net [get_bd_pins User_DMA_0/s_axi_lite_aclk] [get_bd_pins sys_clk_0/clk_out1]
	connect_bd_net [get_bd_pins User_DMA_0/s_axi_lite_aresetn] [get_bd_pins sys_reset_0/peripheral_aresetn]

	# Connect all clock, reset & status pins of User_DMA_0 master interfaces..
	connect_bd_intf_net [get_bd_intf_pins axi_mem_interconnect/S00_AXI] [get_bd_intf_pins User_DMA_0/M_AXI_FULL]
	connect_bd_net [get_bd_pins User_DMA_0/m_axi_full_aclk] [get_bd_pins sys_clk_0/clk_out1]
	connect_bd_net [get_bd_pins User_DMA_0/m_axi_full_aresetn] [get_bd_pins sys_reset_0/peripheral_aresetn]
	connect_bd_net [get_bd_pins User_DMA_0/m_axi_full_txn_done] [get_bd_pins xlconcat_0/In0]
	connect_bd_net [get_bd_pins User_DMA_0/m_axi_full_error] [get_bd_pins xlconcat_0/In1]
	connect_bd_net [get_bd_pins User_DMA_0/m_axi_full_init_axi_txn] [ get_bd_pins axi_gpio_out/gpio_io_o ]

	# Connect all clock & reset of User_DMA_0 streaming interfaces..
	connect_bd_net [get_bd_pins User_DMA_0/s_axis_s2mm_aclk] [get_bd_pins sys_clk_0/clk_out1]
	connect_bd_net [get_bd_pins User_DMA_0/s_axis_s2mm_aresetn] [get_bd_pins sys_reset_0/peripheral_aresetn]
	connect_bd_net [get_bd_pins User_DMA_0/m_axis_mm2s_aclk] [get_bd_pins sys_clk_0/clk_out1]
	connect_bd_net [get_bd_pins User_DMA_0/m_axis_mm2s_aresetn] [get_bd_pins sys_reset_0/peripheral_aresetn]


	# Auto assign address
	assign_bd_address

	# Configure address param & range of User_DMA_0 master interfaces..
	set_property range 16K [get_bd_addr_segs {jtag_axi_0/Data/SEG_axi_bram_ctrl_0_Mem0}]
	set_property range 16K [get_bd_addr_segs {User_DMA_0/M_AXI_FULL/SEG_axi_bram_ctrl_0_Mem0}]
	set_property -dict [list  CONFIG.C_M_AXI_FULL_TARGET_SLAVE_BASE_ADDR {0xC0000000} ] [get_bd_cells User_DMA_0]

	# Copy all address to User_DMA_v1_0_include.tcl file
	set bd_path [get_property DIRECTORY [current_project]]/[current_project].srcs/[current_fileset]/bd
	upvar 1 $offsetfile offset_file
	set offset_file "${bd_path}/User_DMA_v1_0_include.tcl"
	...
	set offset [get_property OFFSET [get_bd_addr_segs /jtag_axi_0/Data/SEG_User_DMA_0_S_AXI_LITE_* ]]
...
set hw_test_file ${ip_path}/example_designs/debug_hw_design/User_DMA_v1_0_hw_test.tcl
...
for { set i 1 } { 1 } { incr i } {
	set design_name "User_DMA_v1_0_hw_${i}"
