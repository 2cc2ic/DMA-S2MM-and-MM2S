...
#define BUFFER0_BASE		0x01000000
#define BUFFER1_BASE		0x02000000
#define BUFFER2_BASE		0x03000000
...
int main(void)
{
	...
	XGpioPs_SetDirectionPin(&psGpioInstancePtr, 53,0);
	XGpioPs_SetOutputEnablePin(&psGpioInstancePtr, 53,0);
	/******************************************************************************/
	...
	XGpio_axi_WriteReg(XPAR_GPIO_LITE_ML_0,0,(u32)BufferPtr[0]);
	XGpio_axi_WriteReg(XPAR_GPIO_LITE_ML_0,4,0x0004b000);
	XGpio_axi_WriteReg(XPAR_GPIO_LITE_ML_0,4,0xFF04b000);
	XGpio_axi_WriteReg(XPAR_GPIO_LITE_ML_0,4,0x0004b000);

	XGpio_axi_WriteReg(XPAR_GPIO_LITE_ML_0,8,(u32)BufferPtr[0]);
