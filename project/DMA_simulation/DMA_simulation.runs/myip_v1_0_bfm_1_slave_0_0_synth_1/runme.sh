...
HD_PWD='E:/git/DMA-S2MM-and-MM2S-/project/DMA_simulation/DMA_simulation.runs/myip_v1_0_bfm_1_slave_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log myip_v1_0_bfm_1_slave_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source myip_v1_0_bfm_1_slave_0_0.tcl
