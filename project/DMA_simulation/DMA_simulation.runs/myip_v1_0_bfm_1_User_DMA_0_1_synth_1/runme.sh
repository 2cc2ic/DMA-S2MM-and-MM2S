...
HD_PWD='D:/git/DMA-S2MM-and-MM2S/project/DMA_simulation/DMA_simulation.runs/myip_v1_0_bfm_1_User_DMA_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log myip_v1_0_bfm_1_User_DMA_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source myip_v1_0_bfm_1_User_DMA_0_1.tcl
