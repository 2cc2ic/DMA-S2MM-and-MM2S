...
-- Date        : Thu Jan 17 21:58:20 2019
-- Host        : hubbery running 64-bit major release  (build 9200)
-- Command     : write_vhdl -force -mode funcsim
--               D:/git/DMA-S2MM-and-MM2S/project/DMA_simulation/DMA_simulation.srcs/sources_1/bd/myip_v1_0_bfm_1/ip/myip_v1_0_bfm_1_AXI_LITE_master_IP_0_0/myip_v1_0_bfm_1_AXI_LITE_master_IP_0_0_sim_netlist.vhdl
...
entity myip_v1_0_bfm_1_AXI_LITE_master_IP_0_0_AXI_LITE_master_IP_v1_0_M00_AXI is
  port (
  ...
  attribute ORIG_REF_NAME of myip_v1_0_bfm_1_AXI_LITE_master_IP_0_0_AXI_LITE_master_IP_v1_0_M00_AXI : entity is "AXI_LITE_master_IP_v1_0_M00_AXI";
end myip_v1_0_bfm_1_AXI_LITE_master_IP_0_0_AXI_LITE_master_IP_v1_0_M00_AXI;

architecture STRUCTURE of myip_v1_0_bfm_1_AXI_LITE_master_IP_0_0_AXI_LITE_master_IP_v1_0_M00_AXI is
  ...
  signal number : STD_LOGIC_VECTOR ( 0 to 0 );
  ...
  attribute SOFT_HLUTNM of \m00_axi_wdata[21]_INST_0\ : label is "soft_lutpair7";
  attribute SOFT_HLUTNM of \number[0]_i_1\ : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of \number[1]_i_1\ : label is "soft_lutpair4";
...
\m00_axi_wdata[0]_INST_0\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"8"
    )
        port map (
...
\m00_axi_wdata[21]_INST_0\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"2"
    )
        port map (
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity myip_v1_0_bfm_1_AXI_LITE_master_IP_0_0_AXI_LITE_master_IP_v1_0 is
  port (
    M_AXI_BREADY : out STD_LOGIC;
    m00_axi_wdata : out STD_LOGIC_VECTOR ( 2 downto 0 );
    m00_axi_rready : out STD_LOGIC;
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of myip_v1_0_bfm_1_AXI_LITE_master_IP_0_0_AXI_LITE_master_IP_v1_0 : entity is "AXI_LITE_master_IP_v1_0";
end myip_v1_0_bfm_1_AXI_LITE_master_IP_0_0_AXI_LITE_master_IP_v1_0;

architecture STRUCTURE of myip_v1_0_bfm_1_AXI_LITE_master_IP_0_0_AXI_LITE_master_IP_v1_0 is
begin
AXI_LITE_master_IP_v1_0_M00_AXI_inst: entity work.myip_v1_0_bfm_1_AXI_LITE_master_IP_0_0_AXI_LITE_master_IP_v1_0_M00_AXI
     port map (
      M_AXI_BREADY => M_AXI_BREADY,
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity myip_v1_0_bfm_1_AXI_LITE_master_IP_0_0 is
  port (
  ...
  attribute NotValidForBitStream of myip_v1_0_bfm_1_AXI_LITE_master_IP_0_0 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of myip_v1_0_bfm_1_AXI_LITE_master_IP_0_0 : entity is "myip_v1_0_bfm_1_AXI_LITE_master_IP_0_0,AXI_LITE_master_IP_v1_0,{}";
  attribute DowngradeIPIdentifiedWarnings : string;
  attribute DowngradeIPIdentifiedWarnings of myip_v1_0_bfm_1_AXI_LITE_master_IP_0_0 : entity is "yes";
  attribute X_CORE_INFO : string;
  attribute X_CORE_INFO of myip_v1_0_bfm_1_AXI_LITE_master_IP_0_0 : entity is "AXI_LITE_master_IP_v1_0,Vivado 2017.4";
end myip_v1_0_bfm_1_AXI_LITE_master_IP_0_0;

architecture STRUCTURE of myip_v1_0_bfm_1_AXI_LITE_master_IP_0_0 is
...
begin
  ...
  m00_axi_wdata(31) <= \^m00_axi_wdata\(0);
  m00_axi_wdata(30) <= \^m00_axi_wdata\(30);
  m00_axi_wdata(29) <= \^m00_axi_wdata\(0);
  m00_axi_wdata(28) <= \^m00_axi_wdata\(0);
  m00_axi_wdata(27) <= \^m00_axi_wdata\(0);
  m00_axi_wdata(26) <= \^m00_axi_wdata\(30);
  m00_axi_wdata(25) <= \^m00_axi_wdata\(0);
  m00_axi_wdata(24) <= \^m00_axi_wdata\(0);
  ...
  m00_axi_wdata(6) <= \^m00_axi_wdata\(0);
  m00_axi_wdata(5) <= \^m00_axi_wdata\(0);
...
inst: entity work.myip_v1_0_bfm_1_AXI_LITE_master_IP_0_0_AXI_LITE_master_IP_v1_0
     port map (
