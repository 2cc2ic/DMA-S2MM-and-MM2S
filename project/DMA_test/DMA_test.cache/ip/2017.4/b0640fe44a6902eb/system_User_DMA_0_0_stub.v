...
//               decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ system_User_DMA_0_0_stub.v
...
module decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix(s_axi_lite_awaddr, s_axi_lite_awprot, 
  ...
  s_axis_s2mm_tstrb, s_axis_s2mm_tlast, s_axis_s2mm_tvalid, s_axis_s2mm_tready, 
  s_axis_s2mm_aclk, s_axis_s2mm_aresetn, m_axi_full_awid, m_axi_full_awaddr, 
  m_axi_full_awlen, m_axi_full_awsize, m_axi_full_awburst, m_axi_full_awlock, 
  m_axi_full_awcache, m_axi_full_awprot, m_axi_full_awqos, m_axi_full_awuser, 
  m_axi_full_awvalid, m_axi_full_awready, m_axi_full_wdata, m_axi_full_wstrb, 
  m_axi_full_wlast, m_axi_full_wuser, m_axi_full_wvalid, m_axi_full_wready, m_axi_full_bid, 
  m_axi_full_bresp, m_axi_full_buser, m_axi_full_bvalid, m_axi_full_bready, 
  m_axi_full_arid, m_axi_full_araddr, m_axi_full_arlen, m_axi_full_arsize, 
  m_axi_full_arburst, m_axi_full_arlock, m_axi_full_arcache, m_axi_full_arprot, 
  m_axi_full_arqos, m_axi_full_aruser, m_axi_full_arvalid, m_axi_full_arready, 
  m_axi_full_rid, m_axi_full_rdata, m_axi_full_rresp, m_axi_full_rlast, m_axi_full_ruser, 
  m_axi_full_rvalid, m_axi_full_rready, m_axi_full_aclk, m_axi_full_aresetn, 
  m_axi_full_txn_done, m_axis_mm2s_tdata, m_axis_mm2s_tstrb, m_axis_mm2s_tlast, 
  m_axis_mm2s_tvalid, m_axis_mm2s_tready, m_axis_mm2s_aclk, m_axis_mm2s_aresetn)
/* synthesis syn_black_box black_box_pad_pin="s_axi_lite_awaddr[3:0],s_axi_lite_awprot[2:0],s_axi_lite_awvalid,s_axi_lite_awready,s_axi_lite_wdata[31:0],s_axi_lite_wstrb[3:0],s_axi_lite_wvalid,s_axi_lite_wready,s_axi_lite_bresp[1:0],s_axi_lite_bvalid,s_axi_lite_bready,s_axi_lite_araddr[3:0],s_axi_lite_arprot[2:0],s_axi_lite_arvalid,s_axi_lite_arready,s_axi_lite_rdata[31:0],s_axi_lite_rresp[1:0],s_axi_lite_rvalid,s_axi_lite_rready,s_axi_lite_aclk,s_axi_lite_aresetn,s_axis_s2mm_tdata[31:0],s_axis_s2mm_tstrb[3:0],s_axis_s2mm_tlast,s_axis_s2mm_tvalid,s_axis_s2mm_tready,s_axis_s2mm_aclk,s_axis_s2mm_aresetn,m_axi_full_awid[0:0],m_axi_full_awaddr[31:0],m_axi_full_awlen[7:0],m_axi_full_awsize[2:0],m_axi_full_awburst[1:0],m_axi_full_awlock,m_axi_full_awcache[3:0],m_axi_full_awprot[2:0],m_axi_full_awqos[3:0],m_axi_full_awuser[0:0],m_axi_full_awvalid,m_axi_full_awready,m_axi_full_wdata[31:0],m_axi_full_wstrb[3:0],m_axi_full_wlast,m_axi_full_wuser[0:0],m_axi_full_wvalid,m_axi_full_wready,m_axi_full_bid[0:0],m_axi_full_bresp[1:0],m_axi_full_buser[0:0],m_axi_full_bvalid,m_axi_full_bready,m_axi_full_arid[0:0],m_axi_full_araddr[31:0],m_axi_full_arlen[7:0],m_axi_full_arsize[2:0],m_axi_full_arburst[1:0],m_axi_full_arlock,m_axi_full_arcache[3:0],m_axi_full_arprot[2:0],m_axi_full_arqos[3:0],m_axi_full_aruser[0:0],m_axi_full_arvalid,m_axi_full_arready,m_axi_full_rid[0:0],m_axi_full_rdata[31:0],m_axi_full_rresp[1:0],m_axi_full_rlast,m_axi_full_ruser[0:0],m_axi_full_rvalid,m_axi_full_rready,m_axi_full_aclk,m_axi_full_aresetn,m_axi_full_txn_done,m_axis_mm2s_tdata[31:0],m_axis_mm2s_tstrb[3:0],m_axis_mm2s_tlast,m_axis_mm2s_tvalid,m_axis_mm2s_tready,m_axis_mm2s_aclk,m_axis_mm2s_aresetn" */;
